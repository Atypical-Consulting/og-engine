---
title: Quick Start — Generate Your First OG Image
description: Get your API key and generate your first OG image in under 2 minutes. Free plan, no credit card required. Includes SDK setup and text validation.
---
...
<details>
<summary>Prefer the terminal? Use curl instead.</summary>
...
<PlaygroundContextual client:visible panels={['content']} initialTitle="My First OG Image" initialDescription="Generated in ~22ms, no browser needed." />
...
- Explore the [Templates Gallery](/templates/gallery/) to see all 12 available designs

...
description: Technical deep-dive into Pretext's Unicode segmentation, line breaking algorithm, and ~0.1ms text layout. CJK, Arabic, emoji, and grapheme clusters.
head:
  - tag: script
    attrs:
    ...
    content: |
      {
        ...
        "@type": "Article",
        "headline": "How Pretext Measures Text Without a Browser",
        "description": "Technical deep-dive into Pretext's Unicode segmentation, line breaking algorithm, and ~0.1ms text layout.",
        "author": {
          "@type": "Organization",
          "name": "OG Engine",
        ...
        "mainEntityOfPage": "https://og-engine.com/blog/how-pretext-measures-text/"
      }
---
...
This tells you height and line count — enough for the `/validate` endpoint. ~0.1ms ([benchmarked](/benchmarks/)).

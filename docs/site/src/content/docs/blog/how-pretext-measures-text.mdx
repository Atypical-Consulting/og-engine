...
description: Technical deep-dive into Pretext's Unicode segmentation, line breaking algorithm, and sub-0.1ms text layout. CJK, Arabic, emoji, and grapheme clusters.
head:
  - tag: script
    attrs:
    ...
    content: |
      {
        ...
        "description": "Technical deep-dive into Pretext's Unicode segmentation, line breaking algorithm, and sub-0.1ms text layout.",
        "author": {
          "@type": "Organization",
          "name": "OG Engine",

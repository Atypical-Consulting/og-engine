...
description: Most OG image generators break on CJK, Arabic, and emoji text. OG Engine handles bidirectional text, grapheme clusters, and mixed scripts natively.
head:
  - tag: script
    attrs:
    ...
    content: |
      {
        ...
        "@type": "Article",
        "headline": "Multilingual OG Images: CJK, Arabic, and Emoji",
        "description": "Most OG image generators break on CJK, Arabic, and emoji text. OG Engine handles bidirectional text, grapheme clusters, and mixed scripts natively.",
        "author": {
          "@type": "Organization",
          "name": "OG Engine",
        ...
        "mainEntityOfPage": "https://og-engine.com/blog/multilingual-og-images/"
      }
---
